...
public class ConfigReportCopy {
    private final XWPFDocument documento = new XWPFDocument();
    private int contadorPasos = 1;
    private final String colorPrincipal;
    static Properties properties;
    static String[] descripcion = new String[0];

    public ConfigReportCopy() throws IOException, InvalidFormatException {
        this.colorPrincipal = "314260";
    ...
    private void tomarCaptura() throws AWTException, IOException, InvalidFormatException {
    ...
    private void crearTablaDetallesEvidencias() {
        ...
        tabla.setWidth("100%");
        String[] titulos = {"Paso", "Descripción del Paso", "Resultado Esperado", "Estado"};
    ...
    public void reportarEvento(String resultadoEsperado, boolean estado, boolean precondicion) throws IOException, InvalidFormatException, AWTException {
       ...
       // String descripcion = null;
        ...
        if (precondicion){
            ...
            descripcion = obtenerDescripcion(true);
        } else {
            celda10.setText("Paso " + contadorPasos);
            if (EXCEPTION == null){
                descripcion = obtenerDescripcion(false);
                this.contadorPasos++;
            } else {
                descripcion = obtenerDescripcion(false);
            }
        ...
        celda11.setText(descripcion);
        celda12.setText(resultadoEsperado);
        celda13.setText(estado ? "Exitoso" : "Fallido");
    ...
    private String[] obtenerDescripcion(boolean precondicion) throws IOException {
        String lValue = null;
        String[] lDataValues = new String[0];
        if(EXCEPTION == null){
