...
public class ConfigReport {
    ...
    public void reportarEvento(String pDescripcion, String pResultadoEsperado, boolean pEstado, boolean pPrecondicion) throws IOException, InvalidFormatException, AWTException {
        ...
        esperado = getResultadoEsperado(pResultadoEsperado);
        if (pDescripcion.equals("")){
            descripcion = descripcionExcel[0];
        } else {
